...
// baker set in Settings → Website & developer. The app POSTs the message built
...
// "✉ Email the full wish list" mailto row, so nothing ever blocks the baker.
//
// One-time setup (developer side, ~10 min, no code):
//   1. Create a free Resend account (resend.com) and verify a sending domain —
//      a DNS TXT record for jienluv2bake.com.my (subdomain `send.` keeps the
//      main domain's mail untouched).
//   2. supabase functions secrets set RESEND_API_KEY <key>
//   3. Optionally RESEND_FROM "Name <wishlist@send.jienluv2bake.com.my>"
//      (defaults to wishlist@send.jienluv2bake.com.my — the Resend-verified domain).
//   4. supabase functions deploy wish-mail

import { createClient } from "jsr:@supabase/supabase-js@2";

// The app calls this function from jienluv2bake.com.my, a different origin than
