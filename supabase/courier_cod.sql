...
-- money is asked for twice, once by the baker and once by the courier. NULL means
-- the charge (if there is one) is paid with the order, and the card's courier line
