    ...
    return el("div", {},
      el("div", { class: "field" },
        ...
        el("p", { class: "hint" }, isStock
          ? "The shopping list buys whole packs only for what this doesn't cover. Baking an order (Baked) takes its ingredients off automatically."
          : "Your order list tops this ingredient back up to this level (in whole packs) whenever it has dropped more than 10% below it, so after baking you still have this on the shelf. Tap No minimum to leave it alone.")),
