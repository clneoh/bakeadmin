...
function buildEditor(state, product) {
  ...
  const nameZh = el("input", { class: "input", placeholder: "e.g. 佛卡夏 — blank keeps English",
    value: product?.nameZh || "" });
  const nameMs = el("input", { class: "input", placeholder: "e.g. Focaccia — blank keeps English",
