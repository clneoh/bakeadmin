...
function openDayOne(state, redraw) {
  ...
  showPopup(el("div", { class: "popup-title-row" }, "Day one"), (refresh, close) => el("div", {},
    ...
    el("p", { class: "card-sub", style: "margin:12px 0 0" },
      "Customers who still owe you need nothing here: leave those orders unpaid and they show under Still to collect. Money you OWE — a loan for the oven — has nowhere to go on purpose: the app keeps a loan as a way of paying, so record what it pays for as it happens."),
